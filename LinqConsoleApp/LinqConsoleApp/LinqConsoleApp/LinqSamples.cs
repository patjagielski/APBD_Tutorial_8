    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task1()
        {
            ...
            var res2 = Emps.Where(e=>e.Job == "Backend programmer").Select(emp=> new {EmployeeName= emp.Ename, emp.Job }).ToList();
        ...
        public void Task3()
        {
        var res = Emps.Max(items => items.Salary);
        ...
        {
            var res = from emp in Emps
                      group emp by emp.Job into newGroup
                      select new
                      {
                        EmployeeJob = newGroup.Key,
                        EmployeeNumber = newGroup.Count()
                      };
        ...
        public void Task10()
        {
            var res = ((from emp in Emps
                      ...
                      .Union(from emp in Emps
                             select new {Ename = "No value", Job = (string)null, HireDate = (DateTime?)null }));
